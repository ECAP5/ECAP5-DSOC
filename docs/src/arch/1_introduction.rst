...
This documents aims at defining the requirements for ECAP5-DSOC as well as describing its architecture. Both user and product requirements will be covered.

Intended Audience and Use
-------------------------

This document targets hardware engineers who shall implement ECAP5-DSOC by refering to the described architecture. Finally, this document shall be used as a technical reference by software engineers configuring ECAP5-DSOC through hardware-software interfaces.
